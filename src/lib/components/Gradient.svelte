...
<script lang="ts">
  export let c1: Color = { r: 73, g: 201, b: 189 }
  export let c2: Color = { r: 138, g: 241, b: 162 }
  export let c3: Color = { r: 81, g: 31, b: 241 }
  export let c4: Color = { r: 162, g: 138, b: 241 }
  export let c5: Color = { r: 162, g: 138, b: 241 }

  const plasma = (canvas: HTMLCanvasElement) => {
    ...
    for (let u = 0; u < mapSize; u++) {
      for (let v = 0; v < mapSize; v++) {
        ...
        heightMap2[i] = Math.floor(normalized * 100)
      }
    }
    ...
    const makePalette = () => makeFiveColorGradient(c1, c2, c3, c4, c5)
...
<div class="bg-black relative">
  <canvas class="h-screen w-full z-[-1] fixed" use:plasma />
  <div class="relative">
    <slot />
  </div>
</div>
